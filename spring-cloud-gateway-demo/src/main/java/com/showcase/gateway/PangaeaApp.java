...
@EnableZuulProxy
public class PangaeaApp {

    private static final Logger log = LoggerFactory.getLogger(PangaeaApp.class);
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PangaeaApp.class);
