package com.showcase.gateway.gateway.ratelimiting;

import com.netflix.zuul.ZuulFilter;
import com.netflix.zuul.context.RequestContext;
import com.showcase.gateway.config.ProjectProperties;
import com.showcase.gateway.security.SecurityUtils;
...
public class RateLimitingFilter extends ZuulFilter {
    ...
    public RateLimitingFilter(RateLimitingRepository rateLimitingRepository, ProjectProperties projectProperties) {
        this.rateLimitingRepository = rateLimitingRepository;
        this.rateLimit = projectProperties.getGateway().getRateLimiting().getLimit();
    }
