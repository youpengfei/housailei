package com.showcase.gateway.config.apidoc;

import static springfox.documentation.builders.PathSelectors.regex;

import com.showcase.gateway.config.Constants;
...
public class SwaggerConfiguration {
     ...
     *
     * @param projectProperties the properties of the application
     * @return the Swagger Springfox configuration
     */
    @Bean
    public Docket swaggerSpringfoxDocket(ProjectProperties projectProperties) {
