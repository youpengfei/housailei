...
public class ProjectProperties {
    ...
    public String[] notInlogParams;

    public String[] getNotInlogParams() {
        return notInlogParams;
    }

    public ProjectProperties setNotInlogParams(String[] notInlogParams) {
        this.notInlogParams = notInlogParams;
        return this;
    }
    ...
    public static class Mail {
        ...
        private String from = "pangaea@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "pangaea API";

        private String description = "pangaea API documentation";
