...
public class CachingHttpHeadersFilter implements Filter {
    ...
    public CachingHttpHeadersFilter(ProjectProperties projectProperties) {
        this.projectProperties = projectProperties;
    }

    @Override
    public void init(FilterConfig filterConfig) throws ServletException {
        CACHE_TIME_TO_LIVE = TimeUnit.DAYS.toMillis(projectProperties.getHttp().getCache().getTimeToLiveInDays());
    }
