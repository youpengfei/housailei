package com.showcase.register.web.rest;

import com.showcase.register.web.rest.dto.EurekaDTO;
    ...
    private List<Map<String, Object>> getApplications() {
        ...
        for (Application app : sortedApplications) {
            ...
            for (InstanceInfo info : app.getInstances()) {
                ...
                instance.put("appGroupName", info.getAppGroupName());
                instance.put("ipAddr", info.getIPAddr());
                instance.put("port", String.valueOf(info.getPort()));
